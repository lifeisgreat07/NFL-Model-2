...
| [Testing the tester](booth-regression-suite.md) | The regression suite for the checking agent: how it avoids fooling itself, and why the one run that matters has not happened yet. |
