...
| [2026-09-15](2026-09-15.md) | #71, #72 and #73 all merged; a phone's zoomed-out board turned out to be `min-width` beating `width` on `.visually-hidden`; four PR bodies carried a bad figure, every one caught by Booth and none by any mechanical check, two of them after the trap entry for the previous one was already written. Second session: the first real week graded cleanly but the page never rebuilt — the guard written for that exact failure named one workflow and was blind to the second (#74) |
