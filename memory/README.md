...
| [2026-09-15](2026-09-15.md) | #71 and #72 merged and #73 opened; a phone's zoomed-out board turned out to be `min-width` beating `width` on `.visually-hidden`; three mis-scoped figures in PR bodies in one day, the last of them after the trap entry for the first was already written |
